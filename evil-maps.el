...
;;(define-key evil-normal-state-map (kbd "C-.") 'evil-repeat-pop) --need for cider-find-var
;;(define-key evil-normal-state-map (kbd "M-.") 'evil-repeat-pop-next) --need for cider-find-var
